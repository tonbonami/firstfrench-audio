#!/usr/bin/env python3
"""
generate_pronon.py — 발음 강좌 전용. 두 모델 hybrid.
- [FR]      → multilingual_v2 (기본, classe/reste 등 final e 정확)
- [FR-V25]  → turbo_v2_5      (단음절·문제 단어. 비명·breathing 회피)
- [KO]      → turbo_v2_5      (기존)
"""
...
WARM_MOTHER = "TojRWZatQyy9dujEdiQ1"
KO_VOICE    = "uyVNoMrnUku1dZyVEXwD"
